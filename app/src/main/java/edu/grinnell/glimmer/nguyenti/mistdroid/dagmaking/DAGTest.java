...
//    assertTrue("leaf tree", root.equals(dagmaking.DAG.makeDAG(root)));
//  }//rootLeafTest
//
//  @Test
...
//    TreeNode dag = dagmaking.DAG.makeDAG(tree);
...
//    TreeNode dagRoot = dagmaking.DAG.makeDAG(root);
...
//    TreeNode twoLeveldag = dagmaking.DAG.makeDAG(twoLeveltree);
